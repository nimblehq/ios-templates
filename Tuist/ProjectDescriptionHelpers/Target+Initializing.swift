...
extension Target {
    ...
    public static func mainTarget(name: String, bundleId: String) -> Target {
        return Target(
            ...
            scripts: [
                TargetScript.sourceryScript(),
                TargetScript.rswiftScript(),
                TargetScript.swiftLintScript(),
                TargetScript.swiftFormatLintScript(),
                TargetScript.firebaseScript()
            ]
        )
    }
    ...
    public static func testsTarget(name: String, bundleId: String) -> Target {
        ...
        return Target(
            ...
            scripts: [
                TargetScript.swiftFormatScript()
            ],
            dependencies: [
                .target(name: name)
            ]
