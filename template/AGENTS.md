...
{PROJECT_NAME}Tests/        → Unit and integration tests (Swift Testing)
{PROJECT_NAME}UITests/      → UI tests (XCTest / XCUITest)
...
- Unit tests: `{PROJECT_NAME}Tests/` using **Swift Testing**
- UI tests: `{PROJECT_NAME}UITests/` using **XCTest / XCUITest**
- Group UI tests by feature or responsibility, such as `Application/`, `Flows/`, `Screens/`, and `Utilities/`
