...
class Constants
  ...
  def self.GSP_STAGING
    './TestDanger/Configurations/Plists/GoogleService/Staging/GoogleService-Info.plist'
  end

  # a gsp file name for production
  def self.GSP_PRODUCTION
    './TestDanger/Configurations/Plists/GoogleService/Production/GoogleService-Info.plist'
  end
